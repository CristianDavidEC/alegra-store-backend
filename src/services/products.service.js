  ...
  return new Promise((resolve, reject) => {
    ...
    pool.query(
      ...
      [
        queryParams.inCode,
        queryParams.inName,
        queryParams.inIdCategory,
        queryParams.inWeight,
        queryParams.inQuantity,
        queryParams.inEntryDateStart,
        queryParams.inEntryDateEnd,
        queryParams.inExpirationDate,
        queryParams.inDescription,
        queryParams.inSalePrice,
        queryParams.inPurchasePrice,
      ],
